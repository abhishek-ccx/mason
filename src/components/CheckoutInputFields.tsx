...
const CheckoutInputFields = () => {
  return (
    <section className="grid grid-rows-3 gap-y-[25px]">
      ...
      <section className="lg:grid lg:grid-cols-2 flex flex-rows items-center gap-[12px]">
        <section className="grid grid-cols-2">
          <p className="flex items-center justify-center text-[16px] leading-[22.4px] tracking-[5px]">
            XXX - XX -
          </p>
