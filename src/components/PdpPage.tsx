          ...
          <section className="flex flex-wrap pt-4 gap-y-5 gap-x-5 items-center">
            {colors.map((item, index) => (
              <button
                ...
                key={index}
                className={`h-10 w-10 bg-cyan-500 rounded-full ring-offset-2 ${
